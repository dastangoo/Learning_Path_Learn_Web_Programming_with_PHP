...
// strtotime(data_string) returns the equivalent timestamp
...
$timeStamp3 = strtotime('first Monday January 2013');
echo '<br />Timestamp for the 1st Monday January in 2013: ', $timeStamp;
