...
$matrix = array(range(0,9), range(0,9), range(0,9), range(0,9), range(0,9), range(0,9), range(0,9), range(0,9), range(0,9),
                range(0,9));

// creating an associative multidimensional array
$multiAssoc = array('a' => array('aa' => 1, 'bb' => 2, 'ac' => 3),
