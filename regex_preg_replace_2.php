...
// The user types in a string with undesirable words
...
// list of bad words
$search = array('/heck/i', '/dastardly/i', '/blining/i', '/stinking/i', '/idiot/i');

// list of replacements
// note that in the replacement list you *do not* use delimters!
