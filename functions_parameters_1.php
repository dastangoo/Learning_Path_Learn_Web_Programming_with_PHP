<?php
// Managing the Code -- Functions: Definging Mandatory and Optional Parameters


// parameters are defined inside paranthesis after the name of the function
function addressTable($name, $addressLine1, $addressLine2, $addressLine3)
{
  ...
  $table .= sprintf('<tr><tr>%s</td></tr>', $addressLine3);
  $table .= '</table>' . PHP_EOL;
  return $table;
}
