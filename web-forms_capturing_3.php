...
// include the "Form" class defintion file
...
if (isset($_POST['data'])) {
  ...
  // NOTE: use var_export($data, TRUE) to produce output of var_dump() without directly outputing right here!
...
$formContents .= $form->input('Name', 'text', 'name', 60, 40);
...
$formTable .= $form->buildForm('userInfo', $_SE RVER['REQUEST_URI'], $form->div('aTable', $formContents));
$formDiv .= $form->div('theForm', $formHeader . $formTable);
$formDiv .= $form->div('data', $postData);
