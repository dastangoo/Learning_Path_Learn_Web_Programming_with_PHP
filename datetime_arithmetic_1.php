...
// you can work directly with timestamps, but you'll have to calculate seconds!
...
echo '<tr><th>Today</th><td>', date('l, d F Y h:i A'), '</td></tr>';
echo '<tr><th>+1 Week</th><td>', date('l, d F Y h:i A', time() + $secondsInDay), '</td></tr>';
echo '<tr><th>+6 Weeks</th><td>', date('l, d F Y h:i A', time() + $secondsInDay * 6), '</td></tr>';
echo '<tr><th>-4 Weeks</th><td>', date('l, d F Y h:i A', time() - $secondsInDay * 4), '</td></tr>';
