...
class Model
{
  ...
  public function showAccountInfo()
  {
    ...
    $info .= sprintf('<br />Is Memeber: %s', var_export($this->isMember, TRUE));
  ...
  {
    if ($id == 1) {
      $userInfo = array('Amelia', 'Earhart', 887766, 234567, TRUE, array('Airplane', 'GP', 'Flying'));
    }
    else {
      $userInfo = array('Winston', 'Churchil', 998877, 1230467, TRUE, array('Cigars', 'Conservative Party', 'Politics'));
    }
    return $userInfo;
  }
}
